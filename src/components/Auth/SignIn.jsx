...
export class SignIn extends Component {
  ...
  submit = (e) => {
    e.preventDefault();
    e.preventDefault();
    const { CompanyEmail, password } = this.state;
    if (CompanyEmail.length > 0 && password.length > 0) {
      const data = {
        CompanyEmail,
        password,
      };
        ...
        <div className="parent">
          ...
          <div className="component2 component_2">
            <div className="sign_up">
              ...
              <div className="hading-title">LogIn In Now</div>
              <div className="form">
                <form>
                  <div className="detail">
                    <label className="name-label">
                      Company Email Id<c style={{ color: "#FF0000" }}>*</c>{" "}
                    </label>{" "}
                    <br />
                    <input
                      className="input"
                  ...
                  <div className="display_checkbox">
                    <div className="checkbox1">
                      <input
                        ...
                        value="Remind"
                      />
                      <label className="check">Remind me</label>
                      <br />
                    </div>
                    <div className="check">Forgot Password?</div>
                  </div>
